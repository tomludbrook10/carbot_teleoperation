...
public:
    explicit KeyboardController(std::queue<CommandRequest>* cq, std::mutex* mu, std::condition_variable* cv,
...
private:
    ...
    float speed_increment_ = 0.1f;
    float steering_increment_ = 0.1f;
